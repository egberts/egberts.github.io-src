...
What was commonly used is called 'Implicit TLS' (using STARTTLS mechanism):  IMAP4, POP3, and few other protocols make uses of STARTTLS (although it is now configured as always Explicit TLS), or having STARTTLS disabled.
