...
modified: 2025-07-15 16:50
status: published
Tags: code syntax, Pelican, markdown, Python, pygmentize, pygments, CSS, fix, HTML
Category: HOWTO
...
Language Supported?
================
What language does `pygmentize` support?

To list all supported code types (also called lexers) in 
the `pygmentize` command-line tool from Pygments, 
